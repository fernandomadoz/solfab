...
class ScriptsParticularesController extends Controller
{
    ...
    public function scripts_particulares($gen_modelo, $filtros_por_campo)
    {
        ...
        if ($gen_modelo == 'Fecha_de_evento') {          
            ...
            $valor_html = '<p><span class="aclaracion_campo_form">'.__('Indique el enlace a google maps donde esté ubicado el lugar, por ejemplo:').'</span> <span class="aclaracion_campo_form_ejemplo"><a href="https://goo.gl/maps/yqM3pMey16z">https://goo.gl/maps/yqM3pMey16z</a></span> </p>';
