  ...
  <section class="content">
    <div class="row">
      <div class="col-xs-12">
        ...
        <div class="alert alert-success alert-dismissible">
          <button type="button" class="close" data-dismiss="alert" aria-hidden="true">×</button>
          <h4><i class="icon fa fa-check"></i> <?php echo $errors->first(); ?></h4>  
        </div>
        <?php } ?>

        <!-- PANEL SOLICITUD -->
          <div class="box box-primary <?php echo $colapsed_panel_solicitud ?>">
...
<!-- FUNCIONES ABM Y CAMBIAR CLIENTE Y MODELOS -->
  ...
  <script type="text/javascript">
    ...
    $gen_seteo_listarCliente = array(
      ...
      'gen_campos_a_ocultar' => 'email_correo|provincia|pais|tipo_de_documento_id|telefono_fijo'
    );
